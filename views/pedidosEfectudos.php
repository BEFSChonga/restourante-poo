...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="booking.php" class="nav-item nav-link">Voltar</a>              
                    </div>
                    <a href="booking.php" class="btn btn-primary py-2 px-4">Faça Uma Encomenda</a>
                </div>
            </nav>
        ...
        <!--Pedido Efectuados  -->
        <hr>
        <h2 id="idEfectuados">Pedido Efectuados</h2>
        <div>
        
            <?php
               require '../models/produtoModel.php';
               $ecomendasObj4 = new Ecomendas();
                //  $carinda = new produto();
                $ecomendasObj4->exibirProdutosEncomendados ();
            ?> 
        </div>
        <hr>
