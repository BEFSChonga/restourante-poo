...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!--Pedido Efectuados  -->
        <hr>
        <h2 id="idEfectuados">Produtos Vendidos</h2>
        <div>
        
            <?php
               require '../models/produtoModel.php';
               $vendasOgj33 = new CozinhaInf();
                //  $carinda = new produto();
                $vendasOgj33->exibirProdutosVendidos();
            ?> 
        </div>
        <hr>
        ...
        <?php 
                // require '../models/produtoModel.php';
                //$ecomendasObj33 = new CozinhaInf();
                 //  $carinda = new produto();
               $vendasOgj33->exibirProdutosEncomendados();
