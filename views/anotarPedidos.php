            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        <a href="actividades.html" class="nav-item nav-link">HOME</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="cadastro-produto.php" class="dropdown-item">Cadastrar</a>
                                <a href="#contactos" class="dropdown-item">Contactos</a>
                            </div>
                        </div>
                    </div>
                    <a href="vendidos.php" class="btn btn-primary py-2 px-4">Vendas Enfectuadas</a>
                </div>
            </nav>
...
<hr>
            ...
            <div class="row g-0">
                                    ...
                                    <div id="tab-1" class="tab-pane fade show p-0 active">
                                        ...
                                        <div class="limitesDiv">
                                            <?php
                                               ...
                                               $vendasOgj1 = new Vendas();
                                              //  $carinda = new produto();
                                                 $vendasOgj1->exibirProdutosDaCarinha();

                                                //echo $vendas->valorPagar ();
                                            ?> 
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Vendas</h5>
                        <h1 class="text-white mb-4" id="idPedido">Efectuar Vendas</h1> 
                        <form action="../controller/produto.php" method="POST">
                            <div class="row g-3">
                           
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit" name="comprarAgora" >Comprar Agora</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <h3 id="menu1" >Produtos Disponives para Compra</h3> 
                ...
                <?php
                        ...
                        $$vendasO = $vendasOgj1->exibirProdutos();
                    ?> 
        </div>
     <hr>
